...
import type { StorageAdapter } from '../../../services/storage/define-adapter.service';
import { STORED_VALUE_LABELS } from '../../../constants/storage/value-type-icons.const';
import type { StorageAdapterState, StorageEntry } from '../../../stores/storage/storage.store';
import { formatSize } from '../../../utils/format-bytes.util';
import { describeAdapterKind, formatReadTime } from '../../../utils/storage/formatters.util';
