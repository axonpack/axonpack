 ...
 *
 * `react-native` cannot be imported here — it ships Flow syntax that bun will not parse — so this
 * covers the platform-free half. Rendering is covered in `example-web`, against the same fixtures.
 */
